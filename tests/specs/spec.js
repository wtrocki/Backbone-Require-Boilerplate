...
// --------------------------
define([ "jquery", "backbone", "text!templates/heading.html", "views/View", "Model", "Collections",
		"MobileRouter"],

function($, Backbone, headerText, View, Model, Collection, MobileRouter) {
	...
	describe("Backbone-Require-Boilerplate (BRB)", function() {
		...
		// Backbone Mobile Router Suite: contains all tests related to Mobile
		// routers
		describe("Backbone mobile routers", function() {
			...
			beforeEach(function() {
				...
				// Stops the router from listening to hashchange events (Required
				// because Backbone will only allow you to run Backbone.history.start()
